...
public:
    ...
    VectorR3& Set( const Quaternion2& );	// Convert quat to rotation vector
    ...
    double Dot(const VectorR3& other);
    ...
    VectorR3& Rotate( const Quaternion2& );	// Rotate according to Quaternion2
...
inline VectorR3 ToVectorR3( const Quaternion2& q )
...
public:
    ...
    RotationMapR3& Set( const Quaternion2& );
...
inline RotationMapR3 ToRotationMapR3( const Quaternion2& q )
...
public:
    ...
    RigidMapR3& SetRotationPart( const Quaternion2& );
...
inline double VectorR3::Dot(const VectorR3& other)
{
