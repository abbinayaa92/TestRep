...
public:
	...
	*/
	static void drawCylinder(double r, Vector3d v, Point3d org, int nrPoints = 6, int h=1);
	...
	*/
	...
	static void drawGround(double size, double spotRadius, int nbSquares, bool drawmaze, double currx, double curry, double currz);
	static void init();
	static void GLUtils::drawsquare1(double x, double y, double z);
	static void GLUtils::drawsquare2(double x, double y, double z);
	static void GLUtils::drawsquare3(double x, double y, double z);
	static void GLUtils::drawsquare4(double x, double y, double z);
